...
const User = ({ navigation }) => {
  ...
  useEffect(() => {
    async function getInfo() {
      ...
      if ((await data).data.status) {
        setinfo((await data).data.message);
      }
      console.log(info);
    }
    getInfo();
    ...
    <View style={styles.container}>
      <View style={styles.displayname}>
        ...
        >
          <Image
            source={icons.heart}
            style={{ tintColor: "#fff", width: 50, height: 50, margin: 20 }}
          ></Image>
        </View>
        <View>
        ...
        <View>
          <Image
            source={icons.edit}
            style={{ tintColor: "#fff", width: 25, height: 25, margin: 20 }}
          ></Image>
        </View>
      </View>
      <View
